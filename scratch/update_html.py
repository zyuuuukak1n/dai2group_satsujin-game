...
# We need to replace everything from <!-- NEWS --> to </section> (the end of References)
# with a <div id="react-root"></div> and the React script block.

# Find the start of NEWS
start_idx = html.find("<!-- NEWS -->")
...
head_part = html[:start_idx]
footer_part = html[end_idx:]

# Also we need to inject React and Babel in the <head>
react_scripts = """
    <!-- React & Babel -->
...
# Insert React scripts before </head>
        ...
        const DATA = {
            ...
            incidents: [
                ...
                },
                {
                    id: 3,
                    title: "第3の犠牲者：佐々木清",
                    summary: "場所・死因不明。最終目撃は21:15、遺体発見は翌朝11:15。",
                    events: [
                ...
                },
                {
                    id: 4,
                    title: "第4の犠牲者：相沢健二",
                    summary: "場所不明。死因不明。殺害時刻は「14:30〜15:30」の間。",
                    events: [
                        "14:00に須藤が目撃。",
                        "14:30に林太郎が確認時は異常なし。",
                        "15:30に遺体発見。"
